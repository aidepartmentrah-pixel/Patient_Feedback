...
async def get_complaints(
    ...
    harm_level_id: Optional[int] = Query(None, description="Filter by harm level ID"),
    case_status_id: Optional[int] = Query(None, description="Filter by case status ID"),
...
async def get_filtered_count(
    ...
    harm_level_id: Optional[int] = Query(None),
