...
PUBLICATION_SUMMARY_SUBJECT = "إشعار: شكاوى جديدة بانتظار المتابعة"

PUBLICATION_SUMMARY_BODY_TEMPLATE = """السلام عليكم ورحمة الله وبركاته،

يُحيطكم قسم الشكاوى وخدمات المرضى علماً بأنّه تمّ إصدار شكاوى جديدة وتوجيهها إلى جهتكم في نظام إدارة الشكاوى.

عدد الشكاوى الموجّهة لجهتكم: {count}

يُرجى تسجيل الدخول إلى النظام لمراجعتها والتعامل معها في الوقت المحدد.

ـــــــ
هذه رسالة تلقائية من نظام إدارة الشكاوى، يُرجى عدم الردّ عليها مباشرةً.
"""
