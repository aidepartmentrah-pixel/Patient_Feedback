"""
Execute Phase G-B2 SQL Migration Script
Creates the APP_DrawerLabel table.
"""
import pyodbc

# Read SQL script
with open('backend/database_migrations/phase_g_b2_create_drawer_label_table.sql', 'r', encoding='utf-8') as f:
    sql_script = f.read()
...
print("="*80)
print("Executing Phase G-B2 SQL Migration Script")
print("="*80)
