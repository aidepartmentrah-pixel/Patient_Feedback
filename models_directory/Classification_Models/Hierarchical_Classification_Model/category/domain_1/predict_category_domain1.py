...
xgb = XGBClassifier()
_xgb_model_path = os.path.join(MODEL_DIR, "xgb_category_domain1.json")
...
temp_to_label = load_temp_to_label(os.path.join(MODEL_DIR, "category_domain1_label_map.json"))
