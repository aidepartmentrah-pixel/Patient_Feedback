...
def train_subcategory_cat5(base_path=None):
    """
    ...
    REPORT_FILE = os.path.join(MODEL_DIR, "report_subcat_cat5.txt")
    ...
    joblib.dump(lr, os.path.join(MODEL_DIR, "lr_subcat_cat5.pkl"))
    ...
    joblib.dump(rf, os.path.join(MODEL_DIR, "rf_subcat_cat5.pkl"))
    ...
    xgb.save_model(os.path.join(MODEL_DIR, "xgb_subcat_cat5.json"))
    ...
    print("==========================================")
    print(" SUBCATEGORY MODEL (CATEGORY=5) TRAINED")
    ...
    standardized_metrics = compute_standardized_metrics(
        model_name=f"Subcategory_Category5_{best_model_name}",
        y_train=y_train,
        y_test=y_test,
        y_pred=best_pred,
...
if __name__ == "__main__":
    models, metrics = train_subcategory_cat5()
    print("\nMetrics per model:")
