...
def main():
    ...
    joblib.dump(lr, os.path.join(MODEL_DIR, "lr_subcat_cat3.pkl"))
    ...
    joblib.dump(rf, os.path.join(MODEL_DIR, "rf_subcat_cat3.pkl"))
    ...
    xgb.save_model(os.path.join(MODEL_DIR, "xgb_subcat_cat3.json"))

    # ============================
    # EVALUATION
    # ============================

    report_path = os.path.join(MODEL_DIR, "report_subcat_cat3.txt")
    with open(report_path, "w", encoding="utf-8") as f:

        f.write("=== SUBCATEGORY MODEL (CATEGORY = 3) ===\n\n")
    ...
    print("==========================================")
    print("✔ SUBCATEGORY MODEL (CATEGORY=3) TRAINED")
