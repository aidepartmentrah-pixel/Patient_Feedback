...
def train_subcategory_cat2(base_path=None):
    """
    ...
    REPORT_FILE = os.path.join(MODEL_DIR, "report_subcat_cat2.txt")
    ...
    standardized_metrics = compute_standardized_metrics(
        model_name=f"Subcategory_Category2_{best_model_name}",
        y_train=y_train,
        y_test=y_test,
        y_pred=best_pred,
...
if __name__ == "__main__":
    models, metrics = train_subcategory_cat2()
    print("\nMetrics per model:")
