...
from model_training_2.Stage.modular_functions import get_embedding, l2_normalize
...
def train_ML_Metric_Mapper_Numeric_prompt():
    # Go to the database train.
         # The code is at (C:\Users\IT\Documents\GitHub Repository\Patient_Feedback\model_training_2\Stage\Training_Internal_Metrics)
         # The database is at : (C:\Users\IT\Documents\GitHub Repository\Patient_Feedback\model_training_2)
    ...
    # Train LR, RF and XB and this table of 12 by 317 and save them in a new folder called "train_ML_Metric_Mapper_Numeric" in : C:\Users\IT\Documents\GitHub Repository\Patient_Feedback\model_training_2\Stage\Training_Internal_Metrics\vocab_models
