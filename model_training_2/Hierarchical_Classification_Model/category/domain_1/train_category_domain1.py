...
DOMAIN_COL = "domain"
CATEGORY_COL = "category"   # <-- labels here are 5 and 7
...
def main():
    ...
    # Filter to domain=1
    df_train = df_train[df_train[DOMAIN_COL] == 1]
    df_test = df_test[df_test[DOMAIN_COL] == 1]
    ...
    print(f"Labels used: {np.unique(y_train).tolist()} (should be [5,7])")
    ...
    label_to_temp = {5: 0, 7: 1}
    temp_to_label = {0: 5, 1: 7}
