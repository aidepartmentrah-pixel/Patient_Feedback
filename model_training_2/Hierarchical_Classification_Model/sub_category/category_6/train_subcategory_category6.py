...
def main():
    ...
    report_path = os.path.join(MODEL_DIR, "report_subcat_cat6.txt")
    with open(report_path, "w", encoding="utf-8") as f:

        f.write("=== SUBCATEGORY MODEL (CATEGORY = 6) ===\n\n")
