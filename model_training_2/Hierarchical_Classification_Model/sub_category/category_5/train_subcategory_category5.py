...
def main():
    ...
    report_path = os.path.join(MODEL_DIR, "report_subcat_cat5.txt")
    with open(report_path, "w", encoding="utf-8") as f:

        f.write("=== SUBCATEGORY MODEL (CATEGORY = 5) ===\n\n")
