"""
train_improvement_opportunity_type_model.py

Training script for "improvement_opportunity_type" using embedding_text1.

Outputs in this folder:
- improvement_opportunity_type_logreg.pkl
- improvement_opportunity_type_rf.pkl
- improvement_opportunity_type_metrics.txt
- improvement_opportunity_type_confusion_matrix_logreg.png
- improvement_opportunity_type_confusion_matrix_rf.png

Usage:
    python train_improvement_opportunity_type_model.py
"""
...
# Output filenames
MODEL_LOGREG = HERE / "improvement_opportunity_type_logreg.pkl"
MODEL_RF = HERE / "improvement_opportunity_type_rf.pkl"
REPORT_PATH = HERE / "improvement_opportunity_type_metrics.txt"
CM_LOGREG = HERE / "improvement_opportunity_type_confusion_matrix_logreg.png"
CM_RF = HERE / "improvement_opportunity_type_confusion_matrix_rf.png"
...
def main():
    try:
        ...
        with open(REPORT_PATH, "w", encoding="utf-8") as f:
            f.write("Improvement Opportunity Type classification results\n\n")
            for name, res in results.items():
                ...
                f.write(res["report"] + "\n\n")
            f.write("Note: improvement_opportunity_type labels are integer encoded.\n")
