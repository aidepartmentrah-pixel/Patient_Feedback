"""
train_severity_level_model.py

Training script for "severity_level" using embedding_text1.

Outputs:
- severity_level_logreg.pkl
- severity_level_rf.pkl
- severity_level_metrics.txt
- severity_level_confusion_matrix_logreg.png
- severity_level_confusion_matrix_rf.png

Usage:
    python train_severity_level_model.py
"""
...
MODEL_RF = HERE / "severity_level_rf.pkl"
REPORT_PATH = HERE / "severity_level_metrics.txt"
CM_LOGREG = HERE / "severity_level_confusion_matrix_logreg.png"
CM_RF = HERE / "severity_level_confusion_matrix_rf.png"
...
def main():
    try:
        ...
        with open(REPORT_PATH, "w", encoding="utf-8") as f:
            f.write("Severity_Level results\n\n")
            for name, res in results.items():
                ...
                f.write(res["report"] + "\n\n")
            f.write("Note: severity_level labels are integer encoded.\n")
