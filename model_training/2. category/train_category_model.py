...
Training script for "category" using embedding_text1.

Outputs:
- category_logreg.pkl
- category_rf.pkl
- category_metrics.txt
- category_confusion_matrix_logreg.png
- category_confusion_matrix_rf.png
...
# Output paths
MODEL_LOGREG = HERE / "category_logreg.pkl"
MODEL_RF = HERE / "category_rf.pkl"
REPORT_PATH = HERE / "category_metrics.txt"
CM_LOGREG = HERE / "category_confusion_matrix_logreg.png"
CM_RF = HERE / "category_confusion_matrix_rf.png"
...
def main():
    try:
        ...
        with open(REPORT_PATH, "w", encoding="utf-8") as f:
            f.write("Category classification results\n\n")
