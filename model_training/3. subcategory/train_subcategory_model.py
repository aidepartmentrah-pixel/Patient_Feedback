...
- subcategory_confusion_matrix_rf.png
...
CM_RF = HERE / "subcategory_confusion_matrix_rf.png"
...
def main():
    try:
        print("Loading train and test tables...")
        ...
        with open(REPORT_PATH, "w", encoding="utf-8") as f:
            f.write("Subcategory classification results\n\n")
            for name, res in results.items():
                ...
                f.write(res["report"] + "\n\n")
            f.write("Note: subcategory labels are integer encoded.\n")
