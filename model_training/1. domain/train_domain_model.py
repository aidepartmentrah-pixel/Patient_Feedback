...
Training script for "domain" using embedding_text1.

Outputs in this folder:
- domain_logreg.pkl
- domain_rf.pkl
- domain_metrics.txt
- domain_confusion_matrix_logreg.png
- domain_confusion_matrix_rf.png
...
# output filenames
MODEL_LOGREG = HERE / "domain_logreg.pkl"
MODEL_RF = HERE / "domain_rf.pkl"
REPORT_PATH = HERE / "domain_metrics.txt"
CM_LOGREG = HERE / "domain_confusion_matrix_logreg.png"
CM_RF = HERE / "domain_confusion_matrix_rf.png"
...
def main():
    try:
        ...
        with open(REPORT_PATH, "w", encoding="utf-8") as f:
            f.write("Domain classification results\n\n")
            for name, res in results.items():
                ...
                f.write(res["report"] + "\n\n")
            f.write("Note: domain labels are integer encoded.\n")
